                        ...
                        <Table className="min-w-full divide-y divide-gray-700"> {/* min-w-full garante que a tabela terá a largura mínima */}
                            <TableHeader className="sticky top-0 bg-slate-800 z-10">
                                <TableRow>
                                    ...
                                    <TableHead className="text-white whitespace-nowrap hidden lg:block">Descrição</TableHead>
                                    <TableHead className="text-white whitespace-nowrap hidden lg:block">Categoria</TableHead>
                            ...
                            <TableBody>
                                {lancamentos.map((lancamento) => (
                                    <TableRow key={lancamento.id} className="hover:bg-slate-700 transition-colors duration-200">
                                        ...
                                        <TableCell className="text-gray-300 whitespace-nowrap hidden lg:block">{lancamento.descricao}</TableCell>
                                        <TableCell className="text-gray-300 whitespace-nowrap hidden lg:block">{lancamento.categoria}</TableCell>
